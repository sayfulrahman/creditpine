<?php
/**
 * Template Name: Mattress Calculator Template
 *
                        ...
                        <div class="creditpine-abc creditpine-par">
                            <div class="creditpine-abc creditpine-ojp">
                                <ul class="creditpine-lmn">
                                    <li>Home</li>
                                    <li>Mattress Calculator</li>
                                </ul>
                            </div>
                            <h1>Mattress Calculator</h1>
        ...
        <div class="creditpine-abc creditpine-qcs">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xl-7">
                        <article>
                            <p>Mattress Miracle is currently constructing our mattress calculator.</p>
