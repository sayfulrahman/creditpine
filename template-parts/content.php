...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<!-- Single part start -->
	<div class="creditpine-abc creditpine-soc">
        <div class="creditpine-abc creditpine-sss">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xl-7">
                        <div class="creditpine-abc creditpine-par">
                            <div class="creditpine-abc creditpine-jjp">
                            ...
                            <h1><?php the_title(); ?></h1>
                            <div class="creditpine-abc creditpine-jjj">
                                <ul class="creditpine-lmn">
                                    <?php
			...
			<p>Our review process is thorough and collaborative, involving a diverse group of non-industry-affiliated researchers and professionals. Prior to publication and during major updates, our content undergoes rigorous scrutiny to maintain factual accuracy and objectivity. We are committed to unbiased reporting, free from the influence of our affiliate partnerships. Plagiarism is strictly prohibited, and we ensure the authenticity and credibility of our information at all times.</p>
															   <p class="creditpine-abc creditpine-8od">You can read more about how we write our content here:</p>
			<ul class="creditpine-lmn">
				<li><a href="https://www.creditpine.com/editorial-policy/">Our Editorial Policy</a></li>
				<li><a href="https://www.creditpine.com/minimizing-bias/">Minimizing Bias</a></li>
			</ul>'><span>✓</span><a href="#">Fact Checked</a></li>
                                </ul>
                            </div>
                            <div class="creditpine-o0o">
                                <div class="creditpine-lmn">
									<?php
                            ...
                            <div class="creditpine-abc creditpine-poy">
                                <div class="creditpine-abc creditpine-xhd"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/svgexport-5.svg" alt="" width="140px"></div>
                                ...
                                <div class="creditpine-abc"><a href="<?php echo esc_url($banner_button_url_value); ?>"><?php echo esc_html($banner_button_label_value); ?></a></div>
                                <?php }; ?>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Single part end -->
    <!-- Content part start -->
    <div class="creditpine-abc creditpine-mli">
        <div class="creditpine-abc creditpine-xcs">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xl-7">
                        <div class="creditpine-jkl">
    ...
    <!-- Content part end -->
    <!-- Join part start -->
    <div class="creditpine-abc creditpine-hui">
        <div class="creditpine-abc creditpine-hss">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xl-7">
                        <div class="creditpine-abc creditpine-poy">
