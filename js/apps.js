document.addEventListener('DOMContentLoaded', function () {
    ...
    const openSidebarBtn = document.getElementById('creditpine-aar');
    const sidebar = document.getElementById('creditpine-yjk');
    const closeSidebarBtn = document.getElementById('creditpine-xxx');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    dropdownItems.forEach(function (item) {
        item.addEventListener('click', function (event) {
            ...
            const innerMenu = clickedDropdown.querySelector('.creditpine-abs');
...
document.addEventListener('DOMContentLoaded', function() {
    var modal = document.querySelector('.creditpine-m2d');
    var closeButton = document.querySelector('.cro');
    var overlay = document.querySelector('.creditpine-mod');
